  ...
  return (
    // <AppContext.Provider >
      ...
      <header className="headline-text">
        <p>OCCASIONALLY, change WE OFFER PERSPECTIVES ON THE DIRECT-TO-CONSUMER LANDSCAPE, RETAIL INNOVATIONS, HAPPENINGS AROUND PACT AND THE ODD CREATIVE EXPERIMENT.</p>
        <p>
        </p>
      </header>
    </div>
    ...
    <div className='footer-blurb'>
      ...
      fewer clients so that we can be accountable and flexible to all the road bumps that inherently come with building something new.</p>
          <button className='work-button' type="button" onClick={() => alert('woah')}>
