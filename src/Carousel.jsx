...
export default function Carousel () {
  return (
    ...
    <Slider className='slider'>
          <Slide className='single-slide' index={0}>I am the first Slide.
          ...
          <Slide className='single-slide' index={1}>I am the second Slide.
          ...
          <Slide className='single-slide' index={2}>I am the third Slide.
          ...
          <Slide className='single-slide' index={3}>I am the fourth Slide.
